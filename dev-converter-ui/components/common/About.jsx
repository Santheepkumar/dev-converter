function About() {
  return (
    <div className="bg-gray-900 border rounded-xl border-gray-900">
            ...
            <ul className="space-y-12 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 sm:space-y-0 lg:gap-x-8">
              <li>
                <div className="space-y-4">
                  <div className="aspect-w-3 aspect-h-2">
                    <img
                      src={require("../../assets/images/IMG_3213_11zon.png")}
                      width="200"
                      height="60"
                    />
                  </div>
                  <div className="text-lg leading-6 font-medium space-y-1">
                    <h3 className="text-white ml-8">Santheepkumar</h3>
                    <p className="text-dark-300  ml-6">Senior Developer</p>
                  </div>
              ...
              <li>
                <div className="space-y-4">
                  <div className="aspect-w-3 aspect-h-2">
                    <img
                      src={require("../../assets/images/IMG_3218_11zon.png")}
                      width="200"
                      height="60"
                    />
                  </div>
                  <div className="text-lg leading-6 font-medium space-y-1">
                    <h3 className="text-white ml-12">Sanjaikumar</h3>
                    <p className="text-dark-300 ml-6">Junior Developer</p>
                  </div>
